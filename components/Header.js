...
function Header() {
  ...
  return (
    ...
    <div className="items-stretch lg:flex justify-between">
  ...
  <div className="flex-none justify-end">
    <button className="btn transition-colors duration-150 border border-blue-500 rounded-lg focus:shadow-outline hover:bg-blue-00 bg-blue-500 hover:text-blue-500 text-blue-100">
      <a>SIGN OUT</a>
    </button>
    <div className="avatar">
      <div className="rounded-full w-10 h-10 m-1 mx-4">
